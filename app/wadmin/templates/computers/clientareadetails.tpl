    ...
    <tr>
      <td><table width="100%" border="0" cellpadding="10" cellspacing="0">
          <tr>
            ...
            <td>{if in_array('firstname',$uneditablefields)}{$clientfirstname}{else}<input type="text" name="firstname" value="{$clientfirstname}" size="50" />{/if}</td>
          </tr>
          <tr>
            <td class="fieldarea">{$LANG.clientarealastname}</td>
            <td>{if in_array('lastname',$uneditablefields)}{$clientlastname}{else}<input type="text" name="lastname" value="{$clientlastname}" size="50" />{/if}</td>
          </tr>
          <tr>
            <td class="fieldarea">{$LANG.clientareacompanyname}</td>
            <td>{if in_array('companyname',$uneditablefields)}{$clientcompanyname}{else}<input type="text" name="companyname" value="{$clientcompanyname}" size="50" />{/if}</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>{if in_array('address1',$uneditablefields)}{$clientaddress1}{else}<input type="text" name="address1" value="{$clientaddress1}" size="50" />{/if}</td>
          </tr>
          <tr>
            <td class="fieldarea">{$LANG.clientareaaddress2}</td>
            <td>{if in_array('address2',$uneditablefields)}{$clientaddress2}{else}<input type="text" name="address2" value="{$clientaddress2}" size="50" />{/if}</td>
          </tr>
          <tr>
            <td class="fieldarea">{$LANG.clientareacity}</td>
            <td>{if in_array('city',$uneditablefields)}{$clientcity}{else}<input type="text" name="city" value="{$clientcity}" size="50" />{/if}</td>
          </tr>
          <tr>
            <td class="fieldarea">{$LANG.clientareastate}</td>
            <td>{if in_array('state',$uneditablefields)}{$clientstate}{else}<input type="text" name="state" value="{$clientstate}" size="50" />{/if}</td>
          </tr>
          <tr>
            <td class="fieldarea">{$LANG.clientareapostcode}</td>
            <td>{if in_array('postcode',$uneditablefields)}{$clientpostcode}{else}<input type="text" name="postcode" value="{$clientpostcode}" size="50" />{/if}</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>{if in_array('phonenumber',$uneditablefields)}{$clientphonenumber}{else}<input type="text" name="phonenumber" value="{$clientphonenumber}" size="50" />{/if}</td>
          </tr>
      </table></td>
    </tr>
  </table>
