...
<p align="center" class="cartheading">{if $domain eq "register"}{$LANG.registerdomainname}{else}{$LANG.transferdomainname}{/if}</p>
...
<input type="submit" value="{$LANG.checkavailability}" class="buttongo" /></div>
