...
<ul class="breadcrumbs">
  ...
  <li class="current"><strong>{$LANG.clientareanavcontacts}</strong>  </li>
  ...
  <table width="100%" cellspacing="0" cellpadding="0" class="frame">
    <tr>
      <td><table width="100%" cellpadding="10" cellspacing="0">
          <tr>
            <td width="25%" class="fieldarea">{$LANG.clientareafirstname}</td>
...
<input type="checkbox" name="permissions[]" id="permorders" value="orders"{if in_array('orders',$permissions)} checked{/if} /> <label for="permorders">{$LANG.subaccountpermsorders}</label></td>
  ...
  <p align="center">
    <input type="button" value="{$LANG.clientareadeletecontact}" class="tiny button alert  radius" onclick="deleteContact()" />
