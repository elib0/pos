...
<div class="row panel radius">
    ...
    <div class="large-6 columns" style="text-align:right"> <b>{$LANG.knowledgebasesearch}:</b></div>
      ...
      <div class="large-4 columns">
       ...
       <div class="large-2 columns"> 
         <input type="submit" value="{$LANG.knowledgebasesearch}" class="button radius postfix" />
      </div>
