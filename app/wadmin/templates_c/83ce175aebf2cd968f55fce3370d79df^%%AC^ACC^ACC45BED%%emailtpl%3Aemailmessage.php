<?php /* Smarty version 2.6.26, created on 2012-06-02 00:00:03
         compiled from emailtpl:emailmessage */ ?>
<p>Estimado(a) <?php echo $this->_tpl_vars['client_name']; ?>
,</p>
<p><span id="result_box" class="short_text" lang="es"><span class="hps">Este es el</span> <span class="hps">tercer</span> <span class="hps">aviso de cobro</span> <span class="hps">que</span> <span class="hps">la factura </span></span>no. <?php echo $this->_tpl_vars['invoice_num']; ?>
 la cual fue generada el <?php echo $this->_tpl_vars['invoice_date_created']; ?>
 y esta retrasada. <span id="result_box" lang="es"><span class="hps">La falta de pago</span> <span class="hps">dará lugar a</span> <span class="hps">suspensión de la cuenta</span><span>.</span></span></p>
