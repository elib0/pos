...
/*
$Id: nusoap.php,v 1.1 2006/02/13 13:20:13 sanjeev.m Exp $
...
* @version  $Id: nusoap.php,v 1.1 2006/02/13 13:20:13 sanjeev.m Exp $
* @access   public
*/
class nusoap_base {
...
#echo "<hr>SERVICE URL: $serviceurl<hr>";
//$serviceurl = $SERVICE_URL;
	...
	function serializeType($name, $type, $value, $use='encoded', $encodingStyle=false)
	{
		...
		if (strpos($type, ':')) {
			...
			if($ns == $this->XMLSchemaVersion ||
				...
				$value = (($value == 'false') or empty($value) or ($value == '0')) ? 'false' : 'true';
...
class nusoap_client extends nusoap_base  {
	...
	* @access   public
	*/
	function nusoap_client($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false){
	...
	* @access   public
	*/
	function call($operation,$params=array(),$namespace='',$soapAction='',$headers=false,$rpcParams=null,$newurl=""){
