<link rel="stylesheet" type="text/css" href="templates/orderforms/{$carttpl}/style-login.css" />

<p class="cartheading">{$LANG.cartexistingclientlogin}</p>
...
<p align="center"><input type="submit" value="{$LANG.loginbutton}" class=" button  radius" /></p>
