...
<span class="plain_header">{$_ADMINLANG.billing.incomeprojection}</span>
...
<span class="header"><img src="images/icons/graphs.png" class="absmiddle" width="16" height="16" /> {$_ADMINLANG.reports.graphs}</span>
<ul class="menu">
...
{if $sidebar eq "clients" OR $sidebar eq "orders" OR $sidebar eq "billing" OR $sidebar eq "support"}

<br>

<span class="header"><img src="images/icons/linktracking.png" class="absmiddle" width="16" height="16" /> {$_ADMINLANG.global.quicklinks}</span>
<ul class="menu">
    <li><a href="orders.php?filter=true&amp;status=Pending">{$_ADMINLANG.stats.pendingorders} ({$sidebarstats.orders.pending})</a></li>
    <li><a href="clients.php?status=Active">{$_ADMINLANG.stats.activeclients} ({$sidebarstats.clients.active})</a></li>
    <li><a href="clientshostinglist.php?status=Active">{$_ADMINLANG.stats.activeservices} ({$sidebarstats.services.active})</a></li>
    <li><a href="clientsdomainlist.php?status=Active">{$_ADMINLANG.stats.activedomains} ({$sidebarstats.domains.active})</a></li>
    <li><a href="invoices.php?status=Overdue">{$_ADMINLANG.stats.overdueinvoices} ({$sidebarstats.invoices.overdue})</a></li>
    <li><a href="supporttickets.php">{$_ADMINLANG.stats.ticketsawaitingreply} ({$sidebarstats.tickets.awaitingreply})</a></li>
</ul>
