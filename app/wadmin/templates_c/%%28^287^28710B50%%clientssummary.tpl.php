<?php /* Smarty version 2.6.26, created on 2012-05-14 11:38:10
         compiled from v4/clientssummary.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'urlencode', 'v4/clientssummary.tpl', 29, false),array('function', 'cycle', 'v4/clientssummary.tpl', 37, false),)), $this); ?>
<div style="font-size:18px;">#<?php echo $this->_tpl_vars['clientsdetails']['userid']; ?>
...
&resetpw=true"><img src="images/icons/resetpw.png" border="0" align="absmiddle" /> <?php echo $this->_tpl_vars['_ADMINLANG']['clients']['resetsendpassword']; ?>
</a>
...
<tr><td><?php echo $this->_tpl_vars['_ADMINLANG']['clients']['taxexempt']; ?>
</td><td><?php echo $this->_tpl_vars['clientsdetails']['taxstatus']; ?>
</td></tr>
<tr class="altrow"><td><?php echo $this->_tpl_vars['_ADMINLANG']['fields']['signupdate']; ?>
</td><td><?php echo $this->_tpl_vars['signupdate']; ?>
</td></tr>
<tr><td><?php echo $this->_tpl_vars['_ADMINLANG']['clientsummary']['clientfor']; ?>
</td><td><?php echo $this->_tpl_vars['clientfor']; ?>
</td></tr>
<tr class="altrow"><td width="110"><?php echo $this->_tpl_vars['_ADMINLANG']['clientsummary']['lastlogin']; ?>
...
<ul>
<li><a href="orders.php?client=<?php echo $this->_tpl_vars['clientsdetails']['userid']; ?>
...
&activateaffiliate=true<?php endif; ?>"><img src="images/icons/affiliates.png" border="0" align="absmiddle" /> <?php if ($this->_tpl_vars['affiliateid']): ?><?php echo $this->_tpl_vars['_ADMINLANG']['clientsummary']['viewaffiliate']; ?>
...
" class="checkprods" /></td><td><a href="clientshosting.php?userid=<?php echo $this->_tpl_vars['clientsdetails']['userid']; ?>
&hostingid=<?php echo $this->_tpl_vars['product']['id']; ?>
...
</td><td><a href="clientshosting.php?userid=<?php echo $this->_tpl_vars['clientsdetails']['userid']; ?>
&hostingid=<?php echo $this->_tpl_vars['product']['id']; ?>
...
" class="checkaddons" /></td><td><a href="clientshosting.php?userid=<?php echo $this->_tpl_vars['clientsdetails']['userid']; ?>
&hostingid=<?php echo $this->_tpl_vars['addon']['hostingid']; ?>
...
</td><td class="fieldarea"><input type="text" size="20" name="nextduedate" class="datepick" /></td><td width="15%" class="fieldlabel"><?php echo $this->_tpl_vars['_ADMINLANG']['fields']['billingcycle']; ?>
