...
function showStrengthBar() {
    document.write('<table align="center" width="100%" ><tr><td>Password Strength:</td><td><div id="pwstrengthpos" style="position:relative;float:left;width:0px;background-color:#33CC00;border:1px solid #000;">&nbsp;</div></td><td><div id="pwstrength">Weak</div></td></tr></table>');
}