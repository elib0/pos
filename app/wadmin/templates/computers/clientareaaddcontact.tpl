    ...
    <tr>
      <td><table width="100%" border="0" cellpadding="10" cellspacing="0">
          <tr>
            ...
            <td><input type="text" name="firstname" value="{$contactfirstname}" size="50" /></td>
          </tr>
          <tr>
            <td class="fieldarea">{$LANG.clientarealastname}</td>
            <td><input type="text" name="lastname" value="{$contactlastname}" size="50" /></td>
          </tr>
          <tr>
            <td class="fieldarea">{$LANG.clientareacompanyname}</td>
            <td><input type="text" name="companyname" value="{$contactcompanyname}" size="50" /></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><input type="text" name="address1" value="{$contactaddress1}" size="50" /></td>
          </tr>
          <tr>
            <td class="fieldarea">{$LANG.clientareaaddress2}</td>
            <td><input type="text" name="address2" value="{$contactaddress2}" size="50" /></td>
          </tr>
          <tr>
            <td class="fieldarea">{$LANG.clientareacity}</td>
            <td><input type="text" name="city" value="{$contactcity}" size="50" /></td>
          </tr>
          <tr>
            <td class="fieldarea">{$LANG.clientareastate}</td>
            <td><input type="text" name="state" value="{$contactstate}" size="50" /></td>
          </tr>
          <tr>
            <td class="fieldarea">{$LANG.clientareapostcode}</td>
            <td><input type="text" name="postcode" value="{$contactpostcode}" size="50" /></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><input type="text" name="phonenumber" value="{$contactphonenumber}" size="50" /></td>
          </tr>
          <tr>
