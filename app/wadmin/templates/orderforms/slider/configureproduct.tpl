...
<p class="cartsubheading">{$LANG.cartchoosecycle}</p>
...
</td></tr><tr><td><p class="cartsubheading">{$LANG.ordersummary}</p>
...
<input type="button" value="{$LANG.continueshopping}" onclick="addtocart('{$productinfo.gid}');" />
