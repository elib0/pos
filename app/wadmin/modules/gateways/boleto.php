...
function boleto_config() {
    ...
    $configarray = array(
     "FriendlyName" => array("Type" => "System", "Value"=>"Boleto"),
     "banco" => array("FriendlyName" => "Banco", "Type" => "dropdown", "Options" => "banestes,bb,bradesco,cef,hsbc,itau,nossacaixa,real,unibanco", ),
     "taxa" => array("FriendlyName" => "Taxa", "Type" => "text", "Size" => "10", ),
     "agencia" => array("FriendlyName" => "Agencia", "Type" => "text", "Size" => "20", ),
     "conta" => array("FriendlyName" => "Conta", "Type" => "text", "Size" => "20", ),
     ...
     "convenio" => array("FriendlyName" => "Convenio", "Type" => "text", "Size" => "20", ),
     "contrato" => array("FriendlyName" => "Contrato", "Type" => "text", "Size" => "20", ),
    );
