				...
				return {
					...
					detect: function(keyboard) {
                        ...
                        if (ipad) {
                            ...
                            sBaseHeight=sBaseHeight-30;
                        }else{
                            baseHeight=baseHeight-20;
                            sBaseHeight=sBaseHeight-5;
                        }
					...
					loadPanel: function (id) {
                        ...
                        $('#chatwindow').html('<div id="cwheader" class="header">'+
                                                  '<div id="menu" class="title" ><img src="../../app/img/back.png" onclick="jqcc.iphone.back();" style="margin-top: 4px;" /><h1 >Chat :: <img src="'+buddyListAvatar[id]+'" width="40px" style=" margin-top: -7px; float: right;" >&nbsp;'+buddyListName[id]+'</h1></div>'+
                                              '</div>'+
                                              '<div id="cwwrapper">'+
                                                  '<div id="cwscroller">'+
                                                      '<ul id="cwlist"></ul>'+
