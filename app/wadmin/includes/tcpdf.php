...
'yellowgreen' => '9acd32'
		...
		require_once(dirname(__FILE__).'/tcpdf_unicode.php');
	...
	public function Footer() {
		...
		if (empty($this->pagegroups)) {
			$pagenumtxt = $_LANG['page'].' '.$this->getAliasNumPage().' / '.$this->getAliasNbPages();
		} else {
			$pagenumtxt = $_LANG['page'].' '.$this->getPageNumGroupAlias().' / '.$this->getPageGroupAlias();
		}
		$this->SetY($cur_y);
		//Print page number
        $this->SetFontSize(8);
