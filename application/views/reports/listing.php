...
<div class="box-form-view">
	<div align="center" style="margin: 10px 0 20px 0">
		<small style="color:#00A629;"><?php echo $this->lang->line('reports_welcome_message'); ?></small>
	</div>
	<div>
		...
		<div style="float: right; width: 420px; margin-bottom: 10px;">
			<ul>
				<li>
					...
					<ul>
						...
						<li><a href="<?php echo site_url('employees/report');?>">Schedule Employee</a></li>
					</ul>
				</li>
			</ul>
		</div>
		...
		<div style="float: right; width: 420px;">
			<ul>
				<li>
					...
					<ul>
						<?php if($this->Employee->has_privilege('Low Stock','notification_alert')){ ?>
