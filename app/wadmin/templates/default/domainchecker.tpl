...
{if $capatacha}<img src="includes/verifyimage.php" align="middle"> <input type="text" name="code" size="10" maxlength="5"> &nbsp;&nbsp;&nbsp; {/if}<input type="submit" value="{$LANG.domainlookupbutton}" class="button" />
