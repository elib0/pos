			...
			$.m = (function () {
				...
				return {
					...
					loadPanel: function (id,name) {
						...
						$('#chatwindow').html('<div id="cwheader" class="header">'+
                                               '<div id="menu" class="title" ><img src="../../app/img/back.png" onclick="jqcc.m.back();" style="margin-top: 9px;" /><h1 >Chat :: <img src="'+buddyListAvatar[id]+'" width="40px" style=" margin-top: -7px; float: right;" >&nbsp;'+buddyListName[id]+'</h1></div>'+
                                              
                                               '</div><div id="cwwrapper"><div id="cwscroller"><ul id="cwlist"></ul></div></div><div id="cwfooter" class="footer"><form onsubmit="return jqcc.m.sendMessage(\''+id+'\')"><input type="text" name="chatmessage" placeholder="<?php echo $m_language[9];?>" id="chatmessage" /></div>');
