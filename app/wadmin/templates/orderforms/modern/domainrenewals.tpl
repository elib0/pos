<script type="text/javascript" src="includes/jscript/jqueryuiw.js"></script>
<script type="text/javascript" src="templates/orderforms/{$carttpl}/js/main.js"></script>
<link rel="stylesheet" type="text/css" href="templates/orderforms/{$carttpl}/style-domainrenwals.css" />

<br />

<div align="center"><span class="cartheading">{$LANG.domainrenewals}</span><br /><a href="#" onclick="showcats();return false;">({$LANG.cartchooseanothercategory})</a></div>
