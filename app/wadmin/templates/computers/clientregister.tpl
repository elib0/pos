    ...
    <tr>
      <td><table width="100%" border="0" cellpadding="10" cellspacing="0">
          <tr>
            ...
            <td><input type="text" name="firstname" size="50" value="{$clientfirstname}" /></td>
          </tr>
          <tr>
            <td class="fieldarea">{$LANG.clientarealastname}</td>
            <td><input type="text" name="lastname" size="50" value="{$clientlastname}" /></td>
          </tr>
          <tr>
            <td class="fieldarea">{$LANG.clientareacompanyname}</td>
            <td><input type="text" name="companyname" size="50" value="{$clientcompanyname}" /></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><input type="text" name="address1" size="50" value="{$clientaddress1}" /></td>
          </tr>
          <tr>
            <td class="fieldarea">{$LANG.clientareaaddress2}</td>
            <td><input type="text" name="address2" size="50" value="{$clientaddress2}" /></td>
          </tr>
          <tr>
            <td class="fieldarea">{$LANG.clientareacity}</td>
            <td><input type="text" name="city" size="50" value="{$clientcity}" /></td>
          </tr>
          <tr>
            <td class="fieldarea">{$LANG.clientareastate}</td>
            <td><input type="text" name="state" size="50" value="{$clientstate}" /></td>
          </tr>
          <tr>
            <td class="fieldarea">{$LANG.clientareapostcode}</td>
            <td><input type="text" name="postcode" size="50" value="{$clientpostcode}" /></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><input type="text" name="phonenumber" size="50" value="{$clientphonenumber}" /></td>
          </tr>
      </table></td>
    </tr>
  </table>
