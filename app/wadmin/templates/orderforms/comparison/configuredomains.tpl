...
<table width="100%" cellspacing="0" cellpadding="0" class="configtable">
<tr><td class="fieldlabel">{$LANG.cartnameserverchoice}:</td><td class="fieldarea"><input type="radio" name="customns" id="usedefaultns" onclick="showcustomns()" checked /> <label for="usedefaultns">{$LANG.cartnameserverchoicedefault}</label><br /><input type="radio" name="customns" id="usecustomns" onclick="showcustomns()" /> <label for="usecustomns">{$LANG.cartnameserverchoicecustom}</label></td></tr>
<tr class="hiddenns"><td class="fieldlabel">{$LANG.domainnameserver1}:</td><td class="fieldarea"><input type="text" name="domainns1" size="40" value="{$domainns1}" /></td></tr>
<tr class="hiddenns"><td class="fieldlabel">{$LANG.domainnameserver2}:</td><td class="fieldarea"><input type="text" name="domainns2" size="40" value="{$domainns2}" /></td></tr>
<tr class="hiddenns"><td class="fieldlabel">{$LANG.domainnameserver3}:</td><td class="fieldarea"><input type="text" name="domainns3" size="40" value="{$domainns3}" /></td></tr>
<tr class="hiddenns"><td class="fieldlabel">{$LANG.domainnameserver4}:</td><td class="fieldarea"><input type="text" name="domainns4" size="40" value="{$domainns4}" /></td></tr>
</table>
</div>
{/if}
