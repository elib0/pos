...
$pdf->Cell(25,6,"Presupuesto #",1,0,'C');
$pdf->Cell(60,6,"Asunto",1,0,'C');
$pdf->Cell(35,6,"Fecha de creado",1,0,'C');
$pdf->Cell(35,6,"Valido hasta",1,1,'C');

$pdf->SetFont('freesans','',9);
$pdf->SetX($pdf->GetX()+10);
$rowcount = $pdf->getNumLines($subject, 60);
$height = $rowcount * 5;
$pdf->MultiCell(25,$height,$quotenumber+243,1,'C',0,0);
