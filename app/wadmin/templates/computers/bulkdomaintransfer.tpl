...
<form method="post" action="domainchecker.php?search=bulktransfer">
  <div class="contentbox" align="center">
    <p align="center">
      ...
      {/if}
      {if $capatacha}<img src="includes/verifyimage.php" alt="Verify Image" border="0" class="absmiddle" />
